...
# Load model
model_path = "data/foM-20241003_190512/eval/epoch4_step-1_sim_evaluation_om-shift_matrix.pth"
model_name = "-foM"
...
def draw_interpretation(pack_ex, texta, textb, label, pred_label, idx):
...
def process_example(idx, example):
    ...
    try:
        ...
        pred_label =  labellist[score.argmax()]
        example_forsave['prediction'] = pred_label
        ...
        draw_interpretation(pack_ex, premise, hypothesis, label, pred_label, idx)
