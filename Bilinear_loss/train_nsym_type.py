"""
Usage:
python train_nsym_type.py

OR
python train_nsym_type pretrained_transformer_model_name batch_size

torchrun --nproc_per_node=4 train_nsym_type.py 
"""
def main():
    import torch
    ...
    test_evaluator(train_loss.model, output_path=model_save_path, steps = 10)
